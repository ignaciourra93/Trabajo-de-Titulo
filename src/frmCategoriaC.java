...
* de la ventana anterior, contiene el mismo codigo de "frmCategoria.java" y el
...
public class frmCategoriaC extends javax.swing.JFrame {
    ...
    private static frmCategoriaC f = null;

    public frmCategoriaC() {
        initComponents();
    ...
    */
    public static synchronized frmCategoriaC getInstance(){
        try {
            if (f == null) {
                f = (frmCategoriaC) Class.forName("frmCategoriaC").newInstance();
            }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtCodCat, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)
