/**
* Este archivo contiene el codigo para la ventana de marcas
* para ingregar, modificar y eliminar una marca de la base de datos
...
public class frmMarca extends javax.swing.JFrame {
    ...
    * Validacion de campo
    */
    private void txtCodMarKeyReleased(java.awt.event.KeyEvent evt) {
        if (txtCodMar.getText().length() > 5) {
            JOptionPane.showMessageDialog(null, "No puede ingresar un codigo de mas de 5 digitos", "Error en el ingreso de codigo marca", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    * Validacion de campo
    */
    private void txtCodMarKeyTyped(java.awt.event.KeyEvent evt) {
    ...
    */
    ...
    private void initComponents() {
        ...
        txtCodMar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCodMarKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtCodMarKeyTyped(evt);
            }
        });
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(txtCodMar, javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGap(0, 0, Short.MAX_VALUE)
                                                .addComponent(txtNomMar, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                        .addGap(49, 49, 49)))))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
