...
* de la ventana anterior, contiene el mismo codigo de "frmProducto.java" y el
...
public class frmProductoC extends javax.swing.JFrame {
    ...
    private static frmProductoC f = null;
    ...
    */
     public static synchronized frmProductoC getInstance(){
        try {
            if (f == null) {
                f = (frmProductoC) Class.forName("frmProductoC").newInstance();
            }
    ...
    */
    private void btnCategoriaActionPerformed(java.awt.event.ActionEvent evt) {
        frmCategoriaC.getInstance().setVisible(true);
        this.dispose();
    }
    ...
    */
    private void btnMarcaActionPerformed(java.awt.event.ActionEvent evt) {
        frmMarcaC.getInstance().setVisible(true);
        this.dispose();
    }
    /**
    ...
    */
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addComponent(cmbBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(frmProductoC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmProductoC().setVisible(true);
            }
        });
    }
